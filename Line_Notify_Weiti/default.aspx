...
<head runat="server">
    ...
    <script>
        ...
        function Auth() {
            ...
            URL += '&client_id=B1qkBOLIxeUjSC8KaRL8nO';   //TODO:這邊要換成你的client_id
            URL += '&redirect_uri=https://linenotify.jjdigi.com.tw/Callback.aspx';   //TODO:要將此redirect url 填回你的 LineNotify後台設定
            URL += '&scope=notify';
            URL += '&state=abcde';
